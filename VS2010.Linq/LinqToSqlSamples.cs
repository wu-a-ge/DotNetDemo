...
namespace SampleQueries {
    ...
    public class LinqToSqlSamples : SampleHarness {
        ...
        private readonly static string connString = "user id=sa;pwd=sa;Server=.;database=northwind;Connection Timeout=10";
        ...
        public void LinqToSqlDataContext01() {
            ...
            string connStr = String.Format(@"Data Source=.;Integrated Security=True;Connect Timeout=30;user id=sa;pwd=sa");
            ...
            try {
                ...
                foreach (ObjectChangeConflict aConflict in /*ex.Conflicts*/db.ChangeConflicts) {
                    ...
                    foreach (MemberChangeConflict memConflict in aConflict.MemberConflicts) {
                        ...
                        //它的意思是你是在本地修改了这个值，而不是你对这个值的更新成功了！
