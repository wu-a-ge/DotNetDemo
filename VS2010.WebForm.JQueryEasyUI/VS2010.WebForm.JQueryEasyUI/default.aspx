<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="VS2010.WebForm.JQueryEasyUI._default" %>
...
<head>
    ...
    <script type="text/javascript" src='js/common.msajax.js'> </script>
    <title>easyui</title>
</head>
<body class="easyui-layout">
    ...
    <div data-options="region:'north',split:true,border:false" style="overflow: hidden;
        ...
        <span style="float: right; padding-right: 20px;" class="head">欢迎 管理员 <a href="#"
            id="editpass">修改密码</a> <a href="#" id="loginOut">安全退出</a></span> <span style="padding-left: 10px;  font-size: 16px;">
                <img src="images/blocks.gif" width="20" height="20" align="absmiddle" />
                后台管理系统</span><span id="bgclock" style="padding-left: 10px"></span>
    </div>
    ...
    <div data-options="region:'center'"  id="mainPanle"   style="background: #eee; overflow-y: hidden">
    ...
    <!--修改密码窗口-->
    <div id="modifypwd" class="easyui-window" data-options="title:'修改密码',collapsible:false,minimizable:false,maximizable:false,iconCls:'icon-save',closed:true,resizable:false" 
