...
[assembly: WebResource("WebCustomControl.js.ClientValidate.js", "application/x-javascript", PerformSubstitution = true)]
//[assembly: WebResource("WebCustomControl","Image/gif", PerformSubstitution = true)]
namespace WebCustomControl
{
    ...
    public class CustomValidateControl : BaseValidator
    {
        ...
        protected override void AddAttributesToRender(HtmlTextWriter writer)
        {
            ...
            {
                Page page = this.Page;
                page.ClientScript.RegisterExpandoAttribute(this.ClientID, "evaluationfunction", "ClientNumValidateFunc");
                page.ClientScript.RegisterExpandoAttribute(this.ClientID, "allowNull", this.AllowNull.ToString());
                page.ClientScript.RegisterExpandoAttribute(this.ClientID, "useToolTip", this.UseToolTip.ToString());
                page.ClientScript.RegisterExpandoAttribute(this.ClientID, "foreColor", this.ForeColor.Name.ToString());             
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (base.RenderUplevel == true)
            {
                Page.ClientScript.RegisterClientScriptResource(this.GetType(), "WebCustomControl.js.ClientValidate.js");
