    ...
    internal static class SqlConnectionHelper
    {
        ...
        private static void EnsureSqlExpressDBFile(string connectionString)
        {
            ...
            foreach (string str4 in strArray)
            {
                ...
                else if (flag2 && (str5.StartsWith("INITIAL CATALOG", StringComparison.Ordinal) || str5.StartsWith("DATABASE", StringComparison.Ordinal)))
                {
                    flag2 = false;
                ...
                else if (flag3 && str5.StartsWith("USER INSTANCE", StringComparison.Ordinal))
                {
                    flag3 = false;
                ...
                else if (flag4 && str5.StartsWith("CONNECT TIMEOUT", StringComparison.Ordinal))
                {
                    flag4 = false;
                }
            }
