                ...
                lock (s_lock)
                {
                    ...
                    try
                    {
                        ...
                        if (s_Enabled)
                        {
                            ...
                            if (HostingEnvironment.IsHosted)
                            {
                                ProvidersHelper.InstantiateProviders(roleManager.Providers, s_Providers, typeof(RoleProvider));
                            }
                            else
                            {
                                foreach (ProviderSettings settings in roleManager.Providers)
                                {
                            ...
                            else
                            {
                                try
                                {
                                    s_Provider = s_Providers[roleManager.DefaultProvider];
                                }
                                catch
                                {
                                }
                            ...
                            if (s_Provider == null)
                            {
                                s_InitializeException = new ConfigurationErrorsException(System.Web.SR.GetString("Def_role_provider_not_found"), roleManager.ElementInformation.Properties["defaultProvider"].Source, roleManager.ElementInformation.Properties["defaultProvider"].LineNumber);
                            }
                        }
                    }
